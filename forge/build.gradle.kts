...
loom {
    forge {
        ...
        mixinConfig(
            "hexecuteif-common.mixins.json",
            "hexecuteif-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hexecuteif.apply-datagen-mixin", "true")
                property("hexecuteif.$platform-datagen", "true")
            }
        }
    }
}

hexecuteifModDependencies {
