...
abstract class HexecuteIfModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexecuteIfModDependenciesExtension>("hexecuteifModDependencies")
