...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexecuteif.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexecuteif-common-common-refmap.json
        // fixed:   hexecuteif-common.refmap.json
